        ...
        {!loading &&
          ...
          filtered.map((item) => {
            ...
            return (
              <div
                key={courseId}
                className="group bg-white rounded-2xl border border-slate-200 p-5 hover:border-sky-300 hover:shadow-lg hover:shadow-sky-100 transition"
              >
  ...
  {status === "ACTIVE" || status === "COMPLETED" ? (
    <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
      ...
      <Link
        ...
        className="inline-flex justify-center items-center rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700"
      >
      ...
      {course?.communityLink && (
        <a
          ...
          className="inline-flex justify-center items-center rounded-lg border border-green-600 px-4 py-2 text-sm font-medium text-green-600 hover:bg-green-50"
        >
          Join Group
        </a>
      )}
      ...
      {course?.instructorPhone && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex justify-center items-center rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium hover:bg-slate-50"
        >
          Contact Instructor
        </a>
      )}
