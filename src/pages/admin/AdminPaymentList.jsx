            ...
            <div className="flex flex-col items-center text-center">
              ...
              {payment.student?.phone && (
                <div className="flex items-center justify-center gap-2 mt-3">
                  <a
                    href={`tel:${payment.student.phone}`}
                    title="Call Student"
                    className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-sky-600 text-white hover:bg-sky-700 transition"
                  >
                  ...
                  <a
                    href={`https://wa.me/${payment.student.phone.replace(/\D/g, "")}`}
                    target="_blank"
...
function DeletePaymentModal({ payment, onClose, onConfirm, deleting }) {
  if (!payment) return null;
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 text-center">
          ...
          <p className="mt-1.5 text-sm text-slate-500">
            {payment.student?.name
              ? `This will permanently delete ${payment.student.name}'s payment request and pending enrollment. The student can upload a new payment proof again.`
              : "This payment request will be permanently deleted."}
          </p>
