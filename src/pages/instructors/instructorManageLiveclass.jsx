...
const InstructorManageLiveClasses = () => {
  ...
  const fetchData = async () => {
    ...
    // Fetch independently — a 403 on live classes (e.g. wrong instructor,
    // not the course owner) shouldn't also hide the course title.
...
export default InstructorManageLiveClasses;