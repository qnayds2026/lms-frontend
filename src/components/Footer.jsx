        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold tracking-tight text-[#0284c7]">Qnayds</span>
            </div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a href="#" aria-label="GitHub" className="text-slate-500 hover:text-[#0284c7] transition-colors">
              ...
              <a href="#" aria-label="Twitter" className="text-slate-500 hover:text-[#0284c7] transition-colors">
              ...
              <a href="#" aria-label="LinkedIn" className="text-slate-500 hover:text-[#0284c7] transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
