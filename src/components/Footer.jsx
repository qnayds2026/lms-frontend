...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#1B2A4A] text-[#FAFAF8]">
      {/* Signature: a soft progress-bar gradient, echoing course-completion bars */}
      <div className="h-1 w-full bg-gradient-to-r from-[#E8A33D] via-[#E8A33D]/60 to-transparent" />
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold tracking-tight">Qnayds</span>
            </div>
            <p className="mt-3 text-sm text-[#FAFAF8]/60 max-w-xs">
              A learning platform built to help you track courses, assignments, and progress in one place.
            </p>
            <div className="mt-5 flex items-center gap-3">
              <a href="#" aria-label="GitHub" className="text-[#FAFAF8]/60 hover:text-[#E8A33D] transition-colors">
              ...
              <a href="#" aria-label="Twitter" className="text-[#FAFAF8]/60 hover:text-[#E8A33D] transition-colors">
              ...
              <a href="#" aria-label="LinkedIn" className="text-[#FAFAF8]/60 hover:text-[#E8A33D] transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          {Object.entries(FOOTER_LINKS).map(([heading, links]) => (
            <div key={heading}>
              <h3 className="text-sm font-semibold text-[#FAFAF8]/90 uppercase tracking-wide">
                {heading}
              </h3>
              <ul className="mt-4 space-y-2">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      to={link.href}
                      className="text-sm text-[#FAFAF8]/60 hover:text-[#E8A33D] transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
